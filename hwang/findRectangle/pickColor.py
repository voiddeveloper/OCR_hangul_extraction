...
# 전역 변수 모음
# 테스트할 파일 이름
testFile = 'hwang/imgSet/real_4.jpg'
...
def makeROI(x, y):
    roi = imgColorBGR[y:y + roiLength, x: x + roiLength]
...
# cv.imwrite('img/result_2.jpg', copyImage)
cv.waitKey(0)